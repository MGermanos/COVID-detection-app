...
class MyFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        super().__init__(parent=None, title='XRAY COVID DETECTION TOOL')
        ...
        self.step1.SetLabel('Step1: Click on the button below to choose an image.')
...
#             openFileDialog.ShowModal()
            ...
            if (result == 0):
                wx.MessageBox('COVID19 detected', 'Result', wx.OK | wx.ICON_EXCLAMATION)
            elif (result == 1):
                ...
                wx.MessageBox('Error', 'Result', wx.OK | wx.ICON_EXCLAMATION)
